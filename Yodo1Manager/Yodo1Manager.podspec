Pod::Spec.new do |s|
    ...
    s.subspec 'Yodo1_Manager' do |ss|
        ...
        ss.preserve_path = tags + '/ChangeLog.txt',tags + '/README.md'
        ...
        ss.dependency 'Yodo1KeyInfo','2.0.0'
        ss.dependency 'Yodo1Commons','2.0.0'
        ss.dependency 'Yodo1ZipArchive','1.0.1'
        ss.dependency 'Yodo1YYModel', '2.0.1'
        ss.dependency 'Yodo1Analytics','2.0.0'
    ...
    s.subspec 'Yodo1_UCenter' do |ss|
        ...
        ss.dependency 'Yodo1UCenter','2.0.0'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',versions
    end
    ...
    s.subspec 'Yodo1_MoreGame' do |ss|
        ...
        ss.dependency 'Yodo1MoreGame','2.0.0'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',versions
    end
    ...
    s.subspec 'Yodo1_Share' do |ss|
        ...
        ss.dependency 'Yodo1Share','2.0.0'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',versions
    end
    ...
    s.subspec 'Yodo1_FBSDKCoreKit' do |ss|
        ...
        ss.dependency 'Yodo1FBSDKCoreKit','1.0.1'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',versions
    end
    ...
    s.subspec 'Yodo1_iRate' do |ss|
        ...
        ss.dependency 'Yodo1iRate','1.0.3'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',versions
    end
     ...
     s.subspec 'Yodo1_GameCenter' do |ss|
        ...
        ss.dependency 'Yodo1GameCenter','2.0.0'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',versions
    end
     s.subspec 'Yodo1_iCloud' do |ss|
        ...
        ss.dependency 'Yodo1iCloud','2.0.0'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',versions
    end
    s.subspec 'Yodo1_Notification' do |ss|
        ...
        ss.dependency 'Yodo1Notification','2.0.0'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',versions
    end
    ...
    s.subspec 'Yodo1_Replay' do |ss|
        ...
        ss.dependency 'Yodo1Replay','2.0.0'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',versions
    end
    ################# Banner ##############
    s.subspec 'Banner_Adview' do |ss|
        ...
        ss.dependency 'BannerAdview','1.0.0'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',versions
    end
    s.subspec 'Banner_Admob' do |ss|
        ...
        ss.dependency 'BannerAdmob','2.0.0'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',versions
    end
    ...
    s.subspec 'Banner_Wmad' do |ss|
        ...
        ss.dependency 'BannerWmad','2.0.0'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',versions
    end
    s.subspec 'Banner_Inmobi' do |ss|
        ...
        ss.dependency 'BannerInmobi','1.0.0'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',versions
    end
        ...
        ss.dependency 'BannerGDTMob','1.0.0'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',versions
    end
    s.subspec 'Banner_Applovin' do |ss|
        ...
        ss.dependency 'BannerApplovin','1.0.0'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',versions
    end
    ...
    s.subspec 'Interstitial_Supersonic' do |ss|
        ...
        ss.dependency 'InterstitialSupersonic','1.0.0'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',versions
    end
    ...
    s.subspec 'Interstitial_Admob' do |ss|
        ...
        ss.dependency 'InterstitialAdmob','2.0.0'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',versions
    end
    ...
    s.subspec 'Interstitial_Tapjoy' do |ss|
        ...
        ss.dependency 'InterstitialTapjoy','1.0.0'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',versions
    end
    ...
    s.subspec 'Interstitial_KTplay' do |ss|
        ...
        ss.dependency 'InterstitialKTplay','2.0.0'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',versions
    end
    ...
    s.subspec 'Interstitial_Adview' do |ss|
        ...
        ss.dependency 'InterstitialAdview','2.0.0'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',versions
    end
    ...
    s.subspec 'Interstitial_Wmad' do |ss|
        ...
        ss.dependency 'InterstitialWmad','2.0.0'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',versions
    end
    ...
    s.subspec 'Interstitial_Applovin' do |ss|
        ...
        ss.dependency 'InterstitialApplovin','2.0.0'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',versions
    end
    ...
    s.subspec 'Interstitial_GDTMob' do |ss|
        ...
        ss.dependency 'InterstitialGDTMob','2.0.0'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',versions
    end
    ...
    s.subspec 'Interstitial_Facebook' do |ss|
        ...
        ss.dependency 'InterstitialFacebook','1.0.0'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',versions
    end
    ...
    s.subspec 'Video_Chance' do |ss|
        ...
        ss.dependency 'VideoChance','2.0.0'
    ...
    s.subspec 'Video_Applovin' do |ss|
        ...
        ss.dependency 'VideoApplovin','2.0.0'
        ss.dependency 'Yodo1Video', Yodo1VideoVersion
        ss.dependency 'Yodo1Manager/Yodo1_Manager',versions
    end
    ...
    s.subspec 'Video_Centrixlink' do |ss|
        ...
        ss.dependency 'VideoCentrixlink','2.0.0'
        ss.dependency 'Yodo1Video', Yodo1VideoVersion
        ss.dependency 'Yodo1Manager/Yodo1_Manager',versions
    end
    ...
    s.subspec 'Video_Chartboost' do |ss|
        ...
        ss.dependency 'VideoChartboost','2.0.0'
        ss.dependency 'Yodo1Video', Yodo1VideoVersion
        ss.dependency 'Yodo1Manager/Yodo1_Manager',versions
    end
    ...
    s.subspec 'Video_Domob' do |ss|
        ...
        ss.dependency 'VideoDomob','2.0.0'
        ss.dependency 'Yodo1Video', Yodo1VideoVersion
        ss.dependency 'Yodo1Manager/Yodo1_Manager',versions
    end
    ...
    s.subspec 'Video_Facebook' do |ss|
        ...
        ss.dependency 'VideoFacebook','2.0.0'
        ss.dependency 'Yodo1Video', Yodo1VideoVersion
        ss.dependency 'Yodo1Manager/Yodo1_Manager',versions
    end
    ...
    s.subspec 'Video_Mobvista' do |ss|
        ...
        ss.dependency 'VideoMobvista','2.0.0'
        ss.dependency 'Yodo1Video', Yodo1VideoVersion
        ss.dependency 'Yodo1Manager/Yodo1_Manager',versions
    end
    ...
    s.subspec 'Video_Tapjoy' do |ss|
        ...
        ss.dependency 'VideoTapjoy','2.0.0'
        ss.dependency 'Yodo1Video', Yodo1VideoVersion
        ss.dependency 'Yodo1Manager/Yodo1_Manager',versions
    end
    ...
    s.subspec 'Video_UnityAds' do |ss|
        ...
        ss.dependency 'VideoUnityAds','2.0.0'
        ss.dependency 'Yodo1Video', Yodo1VideoVersion
        ss.dependency 'Yodo1Manager/Yodo1_Manager',versions
    end
    ...
    s.subspec 'Video_Vungle' do |ss|
        ...
        ss.dependency 'VideoVungle','2.0.0'
        ss.dependency 'Yodo1Video', Yodo1VideoVersion
        ss.dependency 'Yodo1Manager/Yodo1_Manager',versions
    end
    ...
    s.subspec 'Video_YouMi' do |ss|
        ...
        ss.dependency 'VideoYouMi','2.0.0'
        ss.dependency 'Yodo1Video', Yodo1VideoVersion
        ss.dependency 'Yodo1Manager/Yodo1_Manager',versions
    end
    ...
    s.subspec 'Video_Inmobi' do |ss|
        ...
        ss.dependency 'VideoInmobi','2.0.0'
        ss.dependency 'Yodo1Video', Yodo1VideoVersion
        ss.dependency 'Yodo1Manager/Yodo1_Manager',versions
    end
    ...
    s.subspec 'Video_Supersonic' do |ss|
        ...
        ss.dependency 'VideoSupersonic','2.0.0'
        ss.dependency 'Yodo1Video', Yodo1VideoVersion
        ss.dependency 'Yodo1Manager/Yodo1_Manager',versions
    end
    ...
    s.subspec 'Video_KTplay' do |ss|
        ...
        ss.dependency 'VideoKTplay','2.0.0'
        ss.dependency 'Yodo1Video', Yodo1VideoVersion
        ss.dependency 'Yodo1Manager/Yodo1_Manager',versions
    end
    ...
    s.subspec 'Video_SUApplovin' do |ss|
        ...
        ss.dependency 'VideoSUApplovin','2.0.0'
        ss.dependency 'Yodo1Video', Yodo1VideoVersion
        ss.dependency 'Yodo1Manager/Yodo1_Manager',versions
    end

    s.subspec 'Video_SUChartboost' do |ss|
        ss.xcconfig = {
            "GCC_PREPROCESSOR_DEFINITIONS" => 'YODO1_ADS_VIDEO'
        }
        ss.dependency 'VideoSUChartboost','2.0.0'
        ss.dependency 'Yodo1Video', Yodo1VideoVersion
        ss.dependency 'Yodo1Manager/Yodo1_Manager',versions
    end

    s.subspec 'Video_SUUnityAds' do |ss|
        ss.xcconfig = {
            "GCC_PREPROCESSOR_DEFINITIONS" => 'YODO1_ADS_VIDEO'
        }
        ss.dependency 'VideoSUUnityAds','2.0.0'
        ss.dependency 'Yodo1Video', Yodo1VideoVersion
        ss.dependency 'Yodo1Manager/Yodo1_Manager',versions
    end

    s.subspec 'Video_SUVungle' do |ss|
        ss.xcconfig = {
            "GCC_PREPROCESSOR_DEFINITIONS" => 'YODO1_ADS_VIDEO'
        }
        ss.dependency 'VideoSUVungle','2.0.0'
        ss.dependency 'Yodo1Video', Yodo1VideoVersion
        ss.dependency 'Yodo1Manager/Yodo1_Manager',versions
    end

    s.subspec 'Video_SUTapjoy' do |ss|
        ss.xcconfig = {
            "GCC_PREPROCESSOR_DEFINITIONS" => 'YODO1_ADS_VIDEO'
        }
        ss.dependency 'VideoSUTapjoy','2.0.0'
        ss.dependency 'Yodo1Video', Yodo1VideoVersion
        ss.dependency 'Yodo1Manager/Yodo1_Manager',versions
    end

    s.subspec 'Video_SUFacebook' do |ss|
        ss.xcconfig = {
            "GCC_PREPROCESSOR_DEFINITIONS" => 'YODO1_ADS_VIDEO'
        }
        ss.dependency 'VideoSUFacebook','2.0.0'
        ss.dependency 'Yodo1Video', Yodo1VideoVersion
        ss.dependency 'Yodo1Manager/Yodo1_Manager',versions
    end

    s.subspec 'Video_SUAdColony' do |ss|
        ss.xcconfig = {
            "GCC_PREPROCESSOR_DEFINITIONS" => 'YODO1_ADS_VIDEO'
        }
        ss.dependency 'VideoSUAdColony','2.0.0'
        ss.dependency 'Yodo1Video', Yodo1VideoVersion
        ss.dependency 'Yodo1Manager/Yodo1_Manager',versions
    end
