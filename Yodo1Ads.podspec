Pod::Spec.new do |s|
    s.name             = 'Yodo1Ads'
    s.version          = '1.0.0'
    s.summary          = '2017.11.22 Yodo1Ads v1.0.0'
    s.description      = <<-DESC
    ...
    s.source           = { :git => "https://github.com/8AGame/Yodo1Libs.git", :tag => 'Yodo1Ads1.0.0' }
    # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

    s.ios.deployment_target = '8.0'

    s.source_files = tags + '/Yodo1UnityTool/*.{h,mm}'

    s.public_header_files = tags + '/Yodo1UnityTool/*.h'
