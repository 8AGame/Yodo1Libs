Pod::Spec.new do |s|
    ...
    s.source_files = tags + '/ISVungleAdapter.framework/Versions/A/Headers/*.h'

    s.public_header_files = tags + '/ISVungleAdapter.framework/Versions/A/Headers/*.h'


    s.vendored_frameworks = tags + '/ISVungleAdapter.framework'
